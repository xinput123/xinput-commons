...
import com.github.xinput.commons.exception.ReflectException;
...
public class ReflectHelper {
   ...
   * @see #on(Class)
   */
  public static ReflectHelper on(String name) throws ReflectException {
   ...
   * @see #on(Class)
   */
  public static ReflectHelper on(String name, ClassLoader classLoader) throws ReflectException {
   ...
   * @return A wrapped class object, to be used for further reflection.
   */
  public static ReflectHelper on(Class<?> clazz) {
  ...
  private ReflectHelper(Class<?> type) {
    this.object = type;
    this.isClass = true;
  }

  private ReflectHelper(Object object) {
    this.object = object;
    this.isClass = false;
  }
   ...
   * @throws ReflectException If any reflection exception occurred.
   */
  public ReflectHelper set(String name, Object value) throws ReflectException {
    Field field = null;
    try {
      field = field0(name);
      ...
      try {
        Object valueCast = TypeHelper.cast(value, field.getType());
   ...
   * @throws ReflectException If any reflection exception occurred.
   */
  public ReflectHelper field(String name) throws ReflectException {
    try {
   ...
   */
  public Map<String, ReflectHelper> fields() {
    Map<String, ReflectHelper> result = new LinkedHashMap<String, ReflectHelper>();
    Class<?> type = type();
   ...
   */
  public ReflectHelper call(String name) throws ReflectException {
   ...
   * @throws ReflectException If any reflection exception occurred.
   */
  public ReflectHelper call(String name, Object... args) throws ReflectException {
   ...
   * @see #create(Object...)
   */
  public ReflectHelper create() throws ReflectException {
   ...
   * @throws ReflectException If any reflection exception occurred.
   */
  public ReflectHelper create(Object... args) throws ReflectException {
    Class<?>[] types = types(args);
  ...
  public boolean equals(Object obj) {
    if (obj instanceof ReflectHelper) {
      return object.equals(((ReflectHelper) obj).get());
    }
   ...
   */
  private static ReflectHelper on(Constructor<?> constructor, Object... args) throws ReflectException {
    try {
   ...
   */
  private static ReflectHelper on(Method method, Object object, Object... args) throws ReflectException {
    try {
      accessible(method);
